...
export const metadata = { title: 'Popular & Trending — Ayekwa Collective' };
...
export default async function PopularPage({ searchParams }: Props) {
  ...
  // Fetch categories and products (sorted by rating)
  const [categories, productsData] = await Promise.all([
    getCategories().catch(() => []),
    getProducts({ page, limit: 12, sort: 'rating' }).catch(() => ({ items: [], total: 0 })),
  ]);
      ...
      >
        <div className="ul-container">
          <div className="ul-section-title-wrapper text-center">
            ...
            <p style={{ color: '#666', marginBottom: 0 }}>Best-selling and highest-rated items</p>
            <nav aria-label="breadcrumb">
              ...
              >
                ...
                <li className="breadcrumb-item active">Popular</li>
              </ol>
            </nav>
          </div>
        </div>
